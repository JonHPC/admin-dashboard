...
const TasksList = ({children}):React.PropsWithChildren => {
  ...
  // Provides a specific mutation function (which we named as updateTask)
  ...
  return (
    <>
      ...
      {/* the below children will show the modal on top of the task lists*/}
      {children}
    </>
  )
}
